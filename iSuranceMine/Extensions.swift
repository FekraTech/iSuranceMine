...
extension UIColor {
    ...
    static let colors: [UIColor] = [.tealBlue, .blue]
...
extension UIImage {
    ...
    static let names: [String] = ["Isuzu", "Jeep", "Volkswagen", "Toyota", "Porsche", "Subaru", "Land Rover","Lamborghini"]
       // static let names: [String] = ["1", "2", "3", "4", "5", "6", "7", "ecuador", "el salvador", "haiti", "honduras", "mexico", "nicaragua", "panama", "paraguay", "peru", "venezuela"]
